...
var (
	...
	factory    = func() (*rpc.Client, error) { return protorpc.Dial(network, address) }
)
...
func TestPool_PutBack(t *testing.T) {
	...
	conns := make([]*rpc.Client, MaximumCap)
